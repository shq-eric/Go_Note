...
- ###  网络请求Contxt包
- enter description here[context包解析1][9]
- [context包解析2][10]
...
go func(把要用到参数打进来){}() 别去引用外部**变量**(静态 常量ok)
  ...
  ## 测试与优化
 [go test指令介绍](https://deepzz.com/post/the-command-flag-of-go-test.html)
 [go基准测试][15]
  ...
  [9]: https://studygolang.com/articles/11851
  ...
  [15]: https://www.flysnow.org/2017/05/21/go-in-action-go-benchmark-test.html